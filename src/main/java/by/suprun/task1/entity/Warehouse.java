...
public class Warehouse {
    ...
    public CustomArrayParameters getById(int arrayId) throws CustomArrayException {
        if (mapStatistics.containsKey(arrayId)) {
            ...
            throw new CustomArrayException("warehouse does not contain element with id: " + arrayId);
        }
    }
    ...
    public CustomArrayParameters removeById(int arrayId) throws CustomArrayException{
        if (mapStatistics.containsKey(arrayId)) {
    ...
    public CustomArrayParameters clearValue(int arrayId) throws CustomArrayException {
        if(mapStatistics.containsKey(arrayId)){
